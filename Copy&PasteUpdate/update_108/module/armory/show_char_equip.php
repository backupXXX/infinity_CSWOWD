...
function showPlayerEquip($guid, $char, $char_data, $char_stats)
{
 ...
 echo "<tbody><tr><td width=356 height=468 align=left valign=top>";
 echo "<div style=\"position: relative; border: 0px; left: 0; top: 0;\">";
 if (getRace($race)) $frame = $genderId."_".$race.".gif";
 else                $frame="TempPortrait.gif";
 echo "<img src=images/player_info/characterframe/$frame style=\"position: absolute; border: 0px; left: 9; top: 6;\">";
 echo "<img src=images/player_info/characterframe/characterframe.png style=\"position: absolute; border: 0px; left: 0; top: 0;\">";

 echo "<table cellspacing=0 class=playerName style='position: absolute; left: 73; top: 15;'>";
 echo "<tbody>";
