...
function generateBagTable($slot)
{
  ...
  return
   "<table class=noborder width=185px cellSpacing=0 cellPadding=0><tbody>"
...
function drawBankFrame($bag)
{
  ...
  echo "<div style=\"position: relative; width: 392px; height: 354px\">";
  echo "<img src=$img style=\"position: absolute; left: 0px; top: 0px;\">";
